    ...
    list_of_links = [
        ...
        [
            InlineKeyboardButton(
                text="Полистать канал агентства", url="https://t.me/agency4x"
            )
        ],
...
def admin_keyboard():
    buttons = [
        [
            InlineKeyboardButton(
                text="Сколько человек оплатили?", callback_data="user_amount"
            )
        ],
        [InlineKeyboardButton(text="Кто оплатил?", callback_data="buyers_names")],
        [
            InlineKeyboardButton(
                text="Сколько заработали?", callback_data="earned_money"
            )
        ],
    ]
